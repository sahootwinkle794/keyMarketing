...
!function(e) {
    ...
    e.fn.localScroll = function(i) {
        ...
        return (i = e.extend({}, n.defaults, i)).autoscroll && i.hash && location.hash && (i.target && window.scrollTo(0, 0),
        t(0, location, i)),
...
!function(t) {
    ...
    t.fn.fitVids = function(e) {
        ...
        if (!document.getElementById("fit-vids-style")) {
            ...
            d.innerHTML = '<p>x</p><style id="fit-vids-style">.fluid-width-video-wrapper{width:100%;position:relative;padding:0;}.fluid-width-video-wrapper iframe,.fluid-width-video-wrapper object,.fluid-width-video-wrapper embed {position:absolute;top:0;left:0;width:100%;height:100%;}</style>',
        ...
        this.each(function() {
            ...
            (d = (d = d.not("object object")).not(r)).each(function(e) {
                ...
                if (!(i.parents(r).length > 0) && ("embed" !== this.tagName.toLowerCase() || !i.parent("object").length) && !i.parent(".fluid-width-video-wrapper").length) {
                    ...
                    i.wrap('<div class="fluid-width-video-wrapper"></div>').parent(".fluid-width-video-wrapper").css("padding-top", 100 * (d / a) + "%"),
...
(function(e, t, n) {
    var r = {
        ...
        checkBrowser: function() {
            var e = this, r = "translate3d(0px, 0px, 0px)", i = n.createElement("div"), s, o, u, a, f = n.documentElement.style;
...
!function(e) {
    ...
    var t, n, i, o, a, r, s = "Close", l = "BeforeClose", c = "MarkupParse", d = "Open", u = "Change", p = ".mfp", f = "mfp-ready", m = "mfp-removing", g = "mfp-prevent-close", h = function() {}, v = !!window.jQuery, y = e(window), C = function(e, n) {
        t.ev.on("mfp" + e + p, n)
    }, w = function(t, n, i, o) {
        var a = document.createElement("div");
        return a.className = "mfp-" + t,
        i && (a.innerHTML = i),
        o ? n && n.appendChild(a) : (a = e(a),
        n && a.appendTo(n)),
        a
    }, b = function(n, i) {
    ...
    h.prototype = {
        ...
        open: function(n) {
            ...
            if (!t.isOpen) {
                ...
                t.bgOverlay || (t.bgOverlay = w("bg").on("click" + p, (function() {
                    t.close()
                }
                )),
                ...
                b("BeforeOpen"),
                t.st.showCloseBtn && (t.st.closeBtnInside ? (C(c, (function(e, t, n, i) {
        ...
        updateItemHTML: function() {
            ...
            var i = n.type;
            if (b("BeforeChange", [t.currItem ? t.currItem.type : "", i]),
            t.currItem = n,
            !t.currTemplate[i]) {
                var a = !!t.st[i] && t.st[i].markup;
                b("FirstMarkupParse", a),
                t.currTemplate[i] = !a || e(a)
            }
        ...
        _checkIfClose: function(n) {
            if (!e(n).hasClass(g)) {
                ...
                if (i && o || !t.content || e(n).hasClass("mfp-close") || t.preloader && n === t.preloader[0])
                    return !0;
    ...
    e.magnificPopup = {
        ...
        defaults: {
            ...
            fixedBgPos: "auto",
            overflowY: "auto",
            closeMarkup: '<button title="%title%" type="button" class="mfp-close">&times;<span class="visually-hidden">Close</span></button>',
            tClose: "Close (Esc)",
            tLoading: "Loading..."
        }
    },
    e.fn.magnificPopup = function(n) {
        ...
        if ("string" == typeof n)
            if ("open" === n) {
                var o, a = v ? i.data("magnificPopup") : i[0].magnificPopup, r = parseInt(arguments[1], 10) || 0;
    ...
    ;
    var k, T, E, _ = "inline", S = function() {
        E && (T.after(E.addClass(k)).detach(),
        E = null)
    };
            ...
            getInline: function(n, i) {
                ...
                n.src) {
                    ...
                    if (a.length) {
                        ...
                        r && r.tagName && (T || (T = w(k = o.hiddenClass),
                        k = "mfp-" + k),
            ...
            getImage: function(n, i) {
                var o = 0
                  , a = function() {
                    ...
                    n.hasSize = !0,
                    n.loaded = !0,
                    b("ImageLoadComplete")) : 200 > ++o ? setTimeout(a, 100) : r())
                }
                  , r = function() {
        ...
        proto: {
            initZoom: function() {
                ...
                if (n.enabled && t.supportsTransition) {
                    var o, a, r = n.duration, c = function(e) {
            ...
            _getOffset: function(n) {
                var i, o = (i = n ? t.currItem.img : t.st.zoom.opener(t.currItem.el || t.currItem)).offset(), a = parseInt(i.css("padding-top"), 10), r = parseInt(i.css("padding-bottom"), 10);
                ...
                F ? s["-moz-transform"] = s.transform = "translate(" + o.left + "px," + o.top + "px)" : (s.left = o.left,
                s.top = o.top),
                s
            }
        }
    ...
    e.magnificPopup.registerModule("gallery", {
        options: {
            enabled: !1,
            arrowMarkup: '<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"><span class="visually-hidden">%title%</span></button>',
            preload: [0, 2],
    ...
    e.fn.mfpFastClick = function(t) {
        return e(this).each((function() {
            var n, i, o, a, r, s, l, c = e(this);
            W && c.on("touchstart" + Z, (function(e) {
                a = !1,
                s = 1,
                i = (r = e.originalEvent ? e.originalEvent.touches[0] : e.touches[0]).clientX,
                o = r.clientY,
                y.on("touchmove" + Z, (function(e) {
                    s = (r = e.originalEvent ? e.originalEvent.touches : e.touches).length,
                    r = r[0],
                    (Math.abs(r.clientX - i) > 10 || Math.abs(r.clientY - o) > 10) && (a = !0,
                    R())
                }
...
!function(t, e) {
    ...
    a.notSupported = !0,
    r), c = window.getComputedStyle || function(t) {
        var e = /(\-([a-z]){1})/g;
        return {
    ...
    , f = function() {
        function t() {
            ...
            this.wowEvent = function t(e) {
                var n = !(arguments.length <= 1) && void 0 !== arguments[1] && arguments[1]
                  ...
                  , o = void 0;
                return null != document.createEvent ? (o = document.createEvent("CustomEvent")).initCustomEvent(e, n, i, s) : null != document.createEventObject ? (o = document.createEventObject()).eventType = e : o.eventName = e,
                o
        ...
        return l(t, [{
            ...
            value: function() {
                ...
                i(document.readyState, ["interactive", "complete"]) ? this.start() : s(document, "DOMContentLoaded", this.start),
                this.finished = []
            }
        }, {
            key: "start",
            value: function() {
                ...
                this.config.live && new h(function(e) {
                    for (var n = 0; n < e.length; n++)
            ...
            value: function() {
                this.stopped = !0,
                o(this.config.scrollContainer || window, "scroll", this.scrollHandler),
            ...
            value: function(t) {
                ...
                1 === t.nodeType) {
                    t = t.parentNode || t;
                    for (var e = t.querySelectorAll("." + this.config.boxClass), n = 0; n < e.length; n++) {
                        var s = e[n];
                        i(s, this.all) || (this.boxes.push(s),
                        this.all.push(s),
            ...
            value: function(t) {
                ...
                this.config.resetAnimation && (s(t, "animationend", this.resetAnimation),
            ...
            key: "resetAnimation",
            value: function(t) {
                t.type.toLowerCase().indexOf("animationend") >= 0 && (t.target || t.srcElement)
            }
        }, {
            key: "customStyle",
                ...
                for (var n in e)
                    if (e.hasOwnProperty(n)) {
                        ...
                        for (var s = 0; s < this.vendors.length; s++)
                            t["" + this.vendors[s] + n.charAt(0).toUpperCase() + n.substr(1)] = i
                    }
            }
        }, {
            key: "vendorCSS",
            value: function(t, e) {
                for (var n = c(t), i = n.getPropertyCSSValue(e), s = 0; s < this.vendors.length; s++) {
        ...
        if (0 < k.length) {
            ...
            var F, B = function() {
                ...
                for (f = 0; f < a.elems.length; f++) {
                    ...
                    if (e = /transform\s*:/i.exec(b))
                        r = b.slice(e.index),
                        r = (e = r.indexOf(";")) ? " " + r.slice(11, e).replace(/\s/g, "") : " " + r.slice(11).replace(/\s/g, "");
                    d.push({
                        baseX: y.x,
                        baseY: y.y,
                        top: t,
                ...
                (a.options.wrapper ? a.options.wrapper : window).addEventListener("scroll", h, x ? {
                    passive: !0
                } : !1),
                (a.options.wrapper ? a.options.wrapper : document).addEventListener("touchmove", h, x ? {
                    passive: !0
                } : !1))
            }, K = function() {
                for (var f, c = 0; c < a.elems.length; c++) {
                    ...
                    e = f.y - d[c].baseY;
                    b = f.x - d[c].baseX;
                    null !== d[c].min && (a.options.vertical && !a.options.horizontal && (e = e <= d[c].min ? d[c].min : e),
                    ...
                    null !== d[c].max && (a.options.vertical && !a.options.horizontal && (e = e >= d[c].max ? d[c].max : e),
            ...
            a.destroy = function() {
                for (var f = 0; f < a.elems.length; f++)
                    a.elems[f].style.cssText = d[f].style;
                w || (window.removeEventListener("resize", B),
                w = !0);
                D(p);
                p = null
            }
    ...
    jQuery.mbYTPlayer = {
        ...
        checkForStart: function(YTPlayer) {
            ...
            YTPlayer.checkForStartAt = setInterval(function() {
                ...
                if (jQuery.mbBrowser.mobile && (canPlayVideo = !0),
                YTPlayer.player.getDuration() > 0 && YTPlayer.player.getCurrentTime() >= startAt && canPlayVideo) {
                    ...
                    YTPlayer.state = 2,
                    YTPlayer.opt.mute ? $YTPlayer.YTPMute() : YTPlayer.opt.autoPlay ? (console.debug("We muted the audio to make the video 'auto-play' according with the latest vendor policy. The audio will unmute at the first user interaction with the page"),
                    YTPlayer.player.mute(),
                    YTPlayer.forcedMuted = !0,
                    jQuery(document).on("mousedown.YTPstartAudio", function() {
                        YTPlayer.forcedMuted && (console.debug("AAAAAAA"),
                        YTPlayer.player.unMute(),
                        YTPlayer.forcedMuted = !1,
                        jQuery(document).off("mousedown.YTPstartAudio"))
                    }),
                    jQuery(window).on("scroll", function() {})) : YTPlayer.player.unMute(),
...
jQuery.CSS = {
    ...
    normalizeCss: function(e) {
        ...
        for (var t in jQuery.mbBrowser.webkit || jQuery.mbBrowser.opera ? jQuery.CSS.sfx = "-webkit-" : jQuery.mbBrowser.mozilla ? jQuery.CSS.sfx = "-moz-" : jQuery.mbBrowser.msie && (jQuery.CSS.sfx = "-ms-"),
        jQuery.CSS.sfx = "",
        r) {
            ...
            delete r[t]),
            "filter" !== t || jQuery.mbBrowser.mozilla || (r[jQuery.CSS.sfx + "filter"] = e[t],
            delete r[t]),
    ...
    animate: function(e, r, t, a, o) {
        return this.each(function() {
            ...
            if (i.CSSAIsRunning && i.eventType == s.type && !jQuery.mbBrowser.msie && 9 >= jQuery.mbBrowser.version)
                i.CSSqueue = function() {
    ...
    e.simpleSlider = {
        ...
        updateSliderVal: function(r) {
            ...
            if (t.opt) {
                ...
                t.lastVal === t.value && ("h" === t.opt.orientation && (t.x >= this.outerWidth() || 0 >= t.x) || "h" !== t.opt.orientation && (t.y >= this.outerHeight() || 0 >= t.y)) || ("function" == typeof t.opt.callback && t.opt.callback(t),
                t.lastVal = t.value)
            }
        }
    },
...
-1 != (verOffset = nAgt.indexOf("Opera")))
    ...
    -1 != (verOffset = nAgt.indexOf("Edge")) ? (jQuery.mbBrowser.edge = !0,
    jQuery.mbBrowser.name = "Microsoft Edge",
    jQuery.mbBrowser.fullVersion = nAgt.substring(verOffset + 5)) : -1 != (verOffset = nAgt.indexOf("Chrome")) ? (jQuery.mbBrowser.webkit = !0,
    jQuery.mbBrowser.chrome = !0,
    jQuery.mbBrowser.name = "Chrome",
    jQuery.mbBrowser.fullVersion = nAgt.substring(verOffset + 7)) : -1 < nAgt.indexOf("mozilla/5.0") && -1 < nAgt.indexOf("android ") && -1 < nAgt.indexOf("applewebkit") && !(-1 < nAgt.indexOf("chrome")) ? (verOffset = nAgt.indexOf("Chrome"),
    jQuery.mbBrowser.webkit = !0,
    jQuery.mbBrowser.androidStock = !0,
    jQuery.mbBrowser.name = "androidStock",
    jQuery.mbBrowser.fullVersion = nAgt.substring(verOffset + 7)) : -1 != (verOffset = nAgt.indexOf("Safari")) ? (jQuery.mbBrowser.webkit = !0,
    jQuery.mbBrowser.safari = !0,
    jQuery.mbBrowser.name = "Safari",
    jQuery.mbBrowser.fullVersion = nAgt.substring(verOffset + 7),
    -1 != (verOffset = nAgt.indexOf("Version")) && (jQuery.mbBrowser.fullVersion = nAgt.substring(verOffset + 8))) : -1 != (verOffset = nAgt.indexOf("AppleWebkit")) ? (jQuery.mbBrowser.webkit = !0,
    jQuery.mbBrowser.safari = !0,
    jQuery.mbBrowser.name = "Safari",
    jQuery.mbBrowser.fullVersion = nAgt.substring(verOffset + 7),
    -1 != (verOffset = nAgt.indexOf("Version")) && (jQuery.mbBrowser.fullVersion = nAgt.substring(verOffset + 8))) : -1 != (verOffset = nAgt.indexOf("Firefox")) ? (jQuery.mbBrowser.mozilla = !0,
    jQuery.mbBrowser.name = "Firefox",
    jQuery.mbBrowser.fullVersion = nAgt.substring(verOffset + 8)) : (nameOffset = nAgt.lastIndexOf(" ") + 1) < (verOffset = nAgt.lastIndexOf("/")) && (jQuery.mbBrowser.name = nAgt.substring(nameOffset, verOffset),
...
isNaN(jQuery.mbBrowser.majorVersion) && (jQuery.mbBrowser.fullVersion = "" + parseFloat(navigator.appVersion),
jQuery.mbBrowser.majorVersion = parseInt(navigator.appVersion, 10)),
