...
function init_page_sliders() {
    (function ($) {
        ...
        $(".small-item-carousel").owlCarousel({
            autoPlay: 5000,
            stopOnHover: true, // Enables the stop on hover feature
            items: 5,
            itemsDesktop: [1199, 4],
        ...
        // Optionally, to have more control over mouse events
        $('.small-item-carousel').on('mouseover', function () {
            $(this).trigger('owl.stop'); // Manually stop the carousel when hovering
        });

        $('.small-item-carousel').on('mouseleave', function () {
            $(this).trigger('owl.play', 5000); // Resume the carousel when mouse leaves
        });
        ...
        // Work slider
        $(".work-full-slider").addClass("autoplay");
